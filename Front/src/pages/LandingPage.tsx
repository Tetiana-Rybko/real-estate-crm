    ...
    () => [
      ...
      },
      {
        ...
        },
        {
          ...
          extra:
            "Окрема перевага цієї квартири — панорамні види на набережну та аквапарк, які змінюються протягом дня і щоразу виглядають по-новому. Дві лоджії та власна тераса додають ще більше світла, повітря і відчуття життя як у власному будинку. Це простір, який працює на ваш стиль життя. Телефонуйте для перегляду.",
